...
card_content = [html.H1("SQL Simplified: Your Comprehensive Resource for Database Development", className="card-title", style={'color':'#333333', 'fontSize' : '3rem'}), html.P("A Step-by-Step Guide to Building and Managing Databases with SQL", className="card-text"), html.Hr(), dbc.Row([        dbc.Col([            html.P("SQL is the preferred language for managing relational databases for several reasons. Firstly, SQL is a standardized language, meaning it can be used with different database management systems (DBMS) such as MySQL, Oracle, Microsoft SQL Server, and PostgreSQL. This allows developers and administrators to switch between DBMSs without having to learn a new language. Secondly, SQL is a declarative language, which means that users can specify what they want to do with the data, without having to worry about how to do it. This makes SQL easy to learn and use, even for beginners. Finally, SQL is a highly optimized language, with built-in features for indexing, sorting, and filtering data, making it highly efficient for managing large datasets. All of these factors contribute to SQL's popularity and make it an essential tool for managing databases.", style={'textAlign':'left'})], width=7),
...
tabs = dbc.Tabs(
    [dbc.Tab(label="Introduction to SQL", tab_id="intro", label_style={'color':colors['text-white'], 'backgroundColor':'#7be070'}, active_label_style = {"backgroundColor": "#64b55b"}),
     dbc.Tab(label="SQL Operations and Syntax", tab_id="syntax", label_style={'color':colors['text-white'], 'backgroundColor':'#7be070'}, active_label_style = {"backgroundColor": "#64b55b"}),
     dbc.Tab(label='Database Structure', tab_id="structure", label_style={'color':colors['text-white'], 'backgroundColor':'#7be070'}, active_label_style = {"backgroundColor": "#64b55b"}),
     dbc.Tab(label='Kimball Methodology', tab_id="kimball", label_style={'color':colors['text-white'], 'backgroundColor':'#7be070'}, active_label_style = {"backgroundColor": "#64b55b"}),
     dbc.Tab(label="Contact", tab_id="contact", label_style={'color':colors['text-white'], 'backgroundColor':'#7be070'}, active_label_style = {"backgroundColor": "#64b55b"})],
    id="tabs",
    active_tab="intro",
    style={
...
intro_tab = html.Div(
    [
        #html.H2("SQL Introduction", style={'backgroundColor':'#2596be'}),
        dbc.Row([
                dbc.Card(
                    dbc.CardBody(
                        [
...
contact_tab = html.Div(
    [
        #html.H2("Contact", style={'background':'#73c96a'}),
        dbc.Card(
            dbc.CardBody(
                [
